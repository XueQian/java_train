...
create table course(id int not null primary key auto_increment,name varchar(30),time DATE not null,employee_id int not null,constraint foreign key(employee_id) references employee(id) on delete cascade);
